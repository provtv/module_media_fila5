...
type: concept
module: Media
tags: [media, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Media filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Media` estende una classe `Filament\...` direttamente.
